# CustomGas
You'll find a *.tar.gz and a *.whl file in [CustomGas/dist](https://github.com/Dennis-89/CoolProp/blob/main/dist). Download one of them and install the libary with `pip`

Then just [Download the docs](https://github.com/Dennis-89/CoolProp/blob/main/docs/build/html) or read below and have fun!
